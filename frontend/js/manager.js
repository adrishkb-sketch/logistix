        ...
        <tr id="row-wh-${w.id}" style="${rowStyle}">
            ...
            <td>
                <div style="display:flex; gap:8px;">
                    <button class="btn-primary" style="padding:6px 12px; font-size:0.75rem; background:linear-gradient(135deg, #a855f7 0%, #6366f1 100%); border:none; box-shadow:0 2px 8px rgba(168,85,247,0.2);" onclick="triggerAIWarehouseReadiness('${w.id}')">🔮 AI Audit</button>
...
async function triggerAIWarehouseReadiness(whId) {
...
window.triggerAISafetyAudit = triggerAISafetyAudit;
