// Dedicated script for executive_shipments.html
...
async function openManualAssignModal(id) {
    ...
    modal.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
            ...
            <div style="display:flex; gap:10px;">
                <button onclick="resplitRemainingRoute('${id}')" style="background:rgba(245,158,11,0.1); border:1px solid rgba(245,158,11,0.3); color:var(--warning); font-size:0.75rem; font-weight:800; padding:6px 12px; border-radius:8px; cursor:pointer;">🔀 Manual Re-Route</button>
        ...
        document.getElementById('sd-weather-alert-block').innerHTML = `
            <div class="glass-card" style="padding: 15px; border: 1px dashed var(--danger); background: rgba(239, 68, 68, 0.05); border-radius: 12px; margin-bottom: 20px;">
                ...
                <div style="margin-top: 12px; display: flex; gap: 10px; justify-content: flex-start; flex-wrap: wrap;">
                    <button class="btn-primary" onclick="window.location.href='executive_weather.html'" style="width: auto; padding: 6px 12px; font-size: 0.75rem; background: var(--primary); border: none; border-radius: 8px; font-weight: bold; cursor: pointer;">
                        🗺️ View Weather Map
                    </button>
                    ${affectedAlert ? `
