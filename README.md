...
| :--- | :--- | :--- | :--- |
| **AI-Powered Route Splitting** | `decompose_shipment` in [route_engine.py](file:///Users/adrish/Desktop/Projects/logistix/backend/services/route_engine.py#L727) | **Executive Shipments Portal:** [executive_shipments.html](file:///Users/adrish/Desktop/Projects/logistix/frontend/pages/executive_shipments.html) | Automatically decomposes a newly created shipment into optimized multi-leg route segments (first-mile, middle-mile, and last-mile) using Gemini AI. |
| **AI-Powered Driver & Fleet Auto-Assignment** | `auto_assign_shipment` in [assignment.py](file:///Users/adrish/Desktop/Projects/logistix/backend/services/assignment.py#L87) | **Executive Shipments Portal:** [executive_shipments.html](file:///Users/adrish/Desktop/Projects/logistix/frontend/pages/executive_shipments.html) | Automatically selects and assigns the most optimal driver-vehicle pair for each route leg of a shipment once it is created using Gemini AI. |
